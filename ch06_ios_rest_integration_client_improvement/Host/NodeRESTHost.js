...
// 
// Updated version of https://github.com/SeaCatMobi/SeaCatTutorials/tree/master/ch03_ios_rest_integration
// 
// IDs are handled by IOS client (under the hood).
//
...
app.post('/api/movies', function(request, response){
  ...
  movies.push({
    ...
    release: parseInt(requestBody.release)
  });
